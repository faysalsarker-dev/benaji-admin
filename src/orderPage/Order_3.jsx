...
const Order_3 = () => {
    ...
    return (
        <div>
            <h2 className="text-center text-3xl font-extrabold my-4 border-b-2 pb-2 border-green-500">Order 3 Page - <span className="bg-green-400 px-2 rounded-lg text-white">{data.length}</span></h2>
